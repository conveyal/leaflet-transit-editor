...
export default class TransitEditorLayer extends L.LayerGroup {
   ...
   */
  constructor ({ geometry, stops, controlPoints, stopIds, snapStops = [] }) {
    super()
  ...
  getStopNear ({ lng, lat, radiusMeters = 200 }) {
    ...
    return query.find((s) => distance(clickPoint, point([s.stop_lon, s.stop_lat]), 'kilometers') < radiusMeters / 1000) || null
  }
