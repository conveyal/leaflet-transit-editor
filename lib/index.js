...
export default class TransitEditorLayer extends L.LayerGroup {
  ...
  handleClick (e) {
    ...
    this.splice(coord, this.extendFromEnd ? this.segments.length : -1, true, this.createStopOnClick)
  ...
  /** get a control for this layer */
  getControl () {
    return new TransitEditorControl(this)
  }
}
